 ...
 */
class SLuaAssetEditor : public SCompoundWidget
{
public:

	SLATE_BEGIN_ARGS(SLuaAssetEditor) { }
	SLATE_END_ARGS()

public:

	/** Virtual destructor. */
	virtual ~SLuaAssetEditor();
	 ...
	 */
	void Construct(const FArguments& InArgs, ULuaScriptAsset* InTextAsset, const TSharedRef<ISlateStyle>& InStyle);
